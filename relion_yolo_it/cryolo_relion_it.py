                        ...
                        if (ipass == 0 and opts.do_class2d) or (ipass == 1 and opts.do_class2d_pass2):
                            ...
                            if ((not already_had_it) or rerun_batch1):
                                ...
                                if opts.cryolo_finetune and opts.autopick_do_cryolo and not done_fine_tune:
                                    done_fine_tune = True
                                    subset_fine_options = ['Select classes from model.star: == {}run_it{:03d}_model.star'.format(class2d_job, opts.class2d_nr_iter)]
...
def main():
    ...
    print(' RELION_IT: authors: Sjors H.W. Scheres, Takanori Nakane, Colin M. Palmer & Donovan Webb')
    print(' RELION_IT: ')
    print(' RELION_IT: usage: ./cryolo_relion_it.py [extra_options.py [extra_options2.py ....] ] [--gui] [--continue]')
    print(' RELION_IT: ')
