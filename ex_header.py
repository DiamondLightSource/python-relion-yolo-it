...
def metadata_mrc(doc, labels):
	...
	elif metadata['nx'] * metadata['ny'] == Fal_dim: 	detect = 'Falcon III ?'; res = ''
	elif metadata['nx'] * metadata['ny'] == Fal_dim_super: 	detect = 'Falcon III ?'; res = 'Super Resolution'
...
def metadata_frames(doc_header, labels):
	...
	elif nx * ny == Fal_dim: 	detect = 'Falcon III ?'; res = ''
	elif nx * ny == Fal_dim_super: 	detect = 'Falcon III ?'; res = 'Super Resolution'
	else: detect = 'Unsure of detector'; res = ''
