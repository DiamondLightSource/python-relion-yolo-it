...
def flip_x_def(box_val, nx=nx):
    ...
    np.savetxt('/dls/ebic/data/staff-scratch/Donovan/testdata/Ap_K2_PP_GO/cryolo_impurities/train_annotation/FoilHole_22247924_Data_22246559_22246561_20180623_1736-193306_flipx.box',flip_x_box, delimiter= '\t', fmt='%.2f')

    with mrc.new('/dls/ebic/data/staff-scratch/Donovan/testdata/Ap_K2_PP_GO/cryolo_impurities/train_image/FoilHole_22247924_Data_22246559_22246561_20180623_1736-193306_flipx.mrc', overwrite=True) as newx:
...
def flip_y_def(box_val, ny=ny):
    ...
    np.savetxt('/dls/ebic/data/staff-scratch/Donovan/testdata/Ap_K2_PP_GO/cryolo_impurities/train_annotation/FoilHole_22247924_Data_22246559_22246561_20180623_1736-193306_flipy.box',flip_y_box, delimiter= '\t', fmt='%.2f')

    with mrc.new('/dls/ebic/data/staff-scratch/Donovan/testdata/Ap_K2_PP_GO/cryolo_impurities/train_image/FoilHole_22247924_Data_22246559_22246561_20180623_1736-193306_flipy.mrc', overwrite=True) as newy:
